  ...
  head: () => ({
    meta: [
      ...
      { title: "GramBiz AI — Village business advisor" },
      {
        name: "description",
        content:
          "AI advice on which business to start in your village and where, in Hindi or English.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Devanagari:wght@400;500;600;700&family=Space+Grotesk:wght@500;600;700&family=Yatra+One&display=swap",
      },
